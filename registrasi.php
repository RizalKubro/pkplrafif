...
<body background="img/bg/bg.jpg">
     ...
     <div class="container">
          <div class="row my-5">
               <div class="col-md-6 text-center login bg"style=" background-color: rgba(102, 193, 250, 0.7); backdrop-filter: blur(10px); border-radius: 10px;">
                    <h4 class="fw-bold" style="color: white;">SIGN UP</h4>
